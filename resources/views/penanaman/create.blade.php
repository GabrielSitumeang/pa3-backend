                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h2 class="mb-0">{{ __('Tambah Data Penanaman') }}</h2>
                                </div><!-- /.col -->
                            </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('penanaman.store') }}" class="mt-5" method="POST" enctype="multipart/form-data">
                                        @csrf
...
<form action="{{ route('penanaman.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
