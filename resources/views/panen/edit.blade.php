                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h2 class="mb-0">{{ __('Edit Data Panen') }}</h2>
                                </div><!-- /.col -->
                            </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('panen.index') }}" class="md-5" style="color: black; text-decoration: none;"><b>< Kembali</b></a>
                                    <form action="{{ route('panen.update',$panen->id) }}" class="mt-5" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                @foreach ($tanaman as $t)
                                                    <option value="{{ $t->nama_tanaman }}"{{ $t->nama_tanaman == $panen->namatanaman ? 'selected':'' }}>{{ $t->nama_tanaman }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="judul" id="judul" placeholder="Judul" value="{{ $panen->judul }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
