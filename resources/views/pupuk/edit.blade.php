                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h2 class="mb-0">{{ __('Tambah Data Pemupukan') }}</h2>
                                </div><!-- /.col -->
                            </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <a href="{{ route('pupuk.index') }}" class="md-5" style="color: black; text-decoration: none;"><b>< Kembali</b></a>
                                    <form action="{{ route('pupuk.update',$pupuk->id) }}" class="mt-5" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @method('PUT')
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                @foreach ($tanaman as $t)
                                                    <option value="{{ $t->nama_tanaman }}" {{ $t->nama_tanaman == $pupuk->namatanaman ? 'selected':'' }}>{{ $t->nama_tanaman }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="form-control form-select" id="tahapanPupuk" name="tahapanPupuk">
                                                @foreach ($tahapanOptions as $key => $value)
                                                    <option value="{{ $key }}" {{ $key == $pupuk->tahapanPupuk ? 'selected':'' }}>{{ $value }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="jenisPemupukan" class="col-sm-2 col-form-label">Jenis Pemupukan :<span></span></label>
                                            <div class="col-sm-10">
                                                <select class="form-control form-select" id="jenisPemupukan" name="jenisPemupukan">
                                                @foreach ($jenispemupukanOptions as $key => $value)
                                                    <option value="{{ $key }}" {{ $key == $pupuk->jenisPemupukan ? 'selected':'' }}>{{ $value }}</option>
                                                @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="judul" id="judul" placeholder="Judul"  value="{{ $pupuk->judul }}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
