                ...
                <div class="row">
                    <div class="col-12">
                        <div class="content-header">
                            <div class="row mb-2">
                                <div class="col-sm-6">
                                    <h2 class="mb-0">{{ __('Tambah Data Persiapan Lahan') }}</h2>
                                </div><!-- /.col -->
                            </div>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('persiapan.store') }}" class="mt-5" method="POST" enctype="multipart/form-data">
                                        @csrf
...
<div class="row">
    <div class="col-lg-12 margin-tb">
        <div class="pull-left">
            <h2>Tambah Data Persiapan Lahan </h2>
        </div>
...
<form action="{{ route('persiapan.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
